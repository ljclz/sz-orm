...
mod tests {
    ...
    #[test]
    #[should_panic(expected = "invalid foreign key column:")]
    ...
    #[test]
    #[should_panic(expected = "invalid foreign key referenced table:")]
    ...
    #[test]
    #[should_panic(expected = "invalid foreign key action:")]
    ...
    #[test]
    #[should_panic(expected = "invalid table:")]
