...
sz-orm-core 在基础引擎之外提供 21 个高级模块。详见 [使用指南 §3.7](docs/sz-orm使用指南.md#37-sz-orm-core-高级特性模块) 与 [API 参考 §2.22](docs/sz-ormAPI参考.md#22-高级特性模块-api-速查)。
...
| [性能基准](docs/sz-orm性能基准.md) | criterion + 真实 DB + Soak 测试（v4.0） |
| [成熟度评估](docs/sz-orm项目成熟度评估报告.md) | 7 维度成熟度评分（4.98/5） |
| [生产就绪](docs/sz-orm生产就绪报告.md) | 生产部署清单 |
| [架构设计](docs/sz-orm架构设计.md) | 39 包架构概览 |
| [实施进度](docs/sz-orm项目实施进度表.md) | 里程碑与阶段追踪 |
| [工程实践](docs/sz-orm-engineering-practices.md) | Gate 1-10 + 测试金字塔 T1-T6 |
| [与主流 ORM 对比](docs/SZ-ORM%20与主流%20ORM%20对比.md) | Diesel / SeaORM / SQLx 对比 |
| [技术深度评估](docs/sz-orm技术实现深度评估.md) | 设计规格与架构决策 |
| [安全](docs/Security.md) | 安全基线与威胁模型 |
| [API 契约](docs/api-contracts.md) | 公共 API 稳定性契约 |
| [全面审查报告](docs/sz-orm全面审查报告v1.md) | 多维代码审查 |
