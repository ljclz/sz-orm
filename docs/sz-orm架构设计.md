...
| L2 适配 | sz-orm-sqlx | sz-orm-core + sqlx 0.8 + rust_decimal |
...
总计 **1970+ 测试 passed，0 失败**（112 个测试套件，需真实服务的标记 ignored）。
...
*文档版本：v4.0 | crate 版本：0.2.1 | 更新日期：2026-07-20*
