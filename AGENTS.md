...
- 已发布：sz-orm-core 1.0.0 已发布到 crates.io（2026-07-23），当前代码版本 5.1.0（v5.1.0 AI 应用优化方向完整交付：P0×9 + P1×10 + P2×15 = 34 个任务，293 个新增测试；v4.9.0 OWASP Top 10 完整覆盖渗透测试套件交付，85 个测试 + A06 脚本）
